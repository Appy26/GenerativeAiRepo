...
function App() {
  ...
  return (
    <>
      <header>
        <div className={styles.logo}><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3EEfAsRkvIMV5oNqm-g5wObwlrtluPmB7-PYW6CSc6o8G7zMtXODTqs-4Qm28DYlKi-M&usqp=CAU" alt="" /></div><span>FoodFiesta</span>
      </header>
      ...
      <div className={styles.main}>
        {data.length ?
          data?.map((el, i) => {
            return (
              <Card className={styles.child} bg="teal" shadow="sm" padding="lg" radius="md" key={i} withBorder>
